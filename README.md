...
# Gelir/Gider ve Raporlar (ek PIN — iki hesap aynı PIN)
VITE_SENSITIVE_SECTION_PIN=1234
```

`VITE_SENSITIVE_SECTION_PIN`: Ana Sayfa / Takvim / Rezervasyonlar için Firebase girişi yeterli. Gelir-Gider ve Raporlar bu PIN ile açılır; **tarayıcı kapanınca** PIN tekrar istenir (`sessionStorage`). Vercel'de Environment Variables altına ekleyin.
